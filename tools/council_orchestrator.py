...
Bridges:
- Drift Inheritance Axiom (preserve/expand Σ_σ_T, forbid artificial ceilings)
- Curvature-regulated feedback (ΔΦ_T style)
- Living π_r vitality band (99.99% alive principle)
"""
